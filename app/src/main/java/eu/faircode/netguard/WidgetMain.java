...
public class WidgetMain extends AppWidgetProvider {
    private static final String TAG = "Nexplay.Widget";
        ...
        try {
            try {
                ...
                for (int id : appWidgetIds) {
                    ...
                    views.setImageViewResource(R.id.ivEnabled, enabled ? R.drawable.ic_nexplay_circle_white : R.drawable.ic_nexplay_circle_white);
